...
heavy-tailed prior are covered as well as a spline. One that does not, a
SCAD or an MCP or anything with a kink, rejects, and the search stays
derivative-free. Nothing here tests a penalty's behavior to find out
