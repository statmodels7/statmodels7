...
one the criterion integrates over, being held at a boundary where its
own score is exactly zero, so the Laplace approximation wants nothing
from it. A unit diagonal contributes exactly that: \\\log\lvert
