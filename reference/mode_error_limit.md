...
[`optimizers7::crit_abs_obj()`](https://statmodels7.github.io/optimizers7/reference/crit_abs_obj.html)
would read as license to stop.

The quantity tested is in log-likelihood units, not in the
