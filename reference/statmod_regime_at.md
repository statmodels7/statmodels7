...
[`term_loglik`](https://statmodels7.github.io/modelterms7/reference/term_loglik.html)
and not from the density at a single predictor. What makes everything
else follow is Fisher's identity – the derivative of that mixed
...
log-density once per state, vectorized, and weights.
