...
[statmodels7](https://statmodels7.github.io/statmodels7/) is the
modeling layer of the [statmodels7](https://statmodels7.github.io)
toolkit, and the package that installs the rest of it.
[`statmod()`](https://statmodels7.github.io/statmodels7/reference/statmod.md)
reads one formula carrying an equation for every parameter of a
distribution and fits it, with any term of
[modelterms7](https://statmodels7.github.io/modelterms7/) in any of
those equations.
...
REML, whose gradient and Hessian are computed exactly, and
...
[`summary()`](https://rdrr.io/r/base/summary.html) prints the two
together, one block per equation, with the effective degrees of freedom
each penalized term spends.
...
The last line of that table comes from
[`statmod_certificate()`](https://statmodels7.github.io/statmodels7/reference/statmod_certificate.md),
which is computed at the point the fit reached rather than read off the
...
[`predict()`](https://rdrr.io/r/stats/predict.html) answers for any
parameter, or for a moment of the response, and carries a standard error
through whatever the terms are.
...
information of the joint model behind
[`vcov()`](https://rdrr.io/r/stats/vcov.html).

The hyperparameters of a smooth penalty come from
...
study needs: the truth is returned beside the data.
...
what masks what, and `statmodels7_update("install")` installs or updates
every member.
